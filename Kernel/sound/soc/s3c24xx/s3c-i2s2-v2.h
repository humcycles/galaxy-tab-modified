...
#ifndef __SND_SOC_S3C24XX_S3C_I2SV2_I2S2_H
#define __SND_SOC_S3C24XX_S3C_I2SV2_I2S2_H
...
struct s3c_i2s2v2_info {
	...
	u32           iisfic;
	u32           iispsr;
	//u32           audss_clksrc;//sayanta not needed for i2s2
	// u32           audss_clkdiv;
	//u32           audss_clkgate;
	u32           clk_rate;
};

struct s3c_i2s2v2_rate_calc {
	unsigned int	clk_div;	/* for prescaler */
	unsigned int	fs_div;		/* for root frame clock */
};

extern int s3c_i2s2v2_iis_calc_rate(struct s3c_i2s2v2_rate_calc *info,
		unsigned int *fstab,
 ...
 */
extern int s3c_i2s2v2_probe(struct platform_device *pdev,
 ...
 * soc core.
 */
extern void s3c_i2s2v2_register_dai(struct snd_soc_dai *dai);

#endif /* __SND_SOC_S3C24XX_S3C_I2SV2_I2S2_H */
