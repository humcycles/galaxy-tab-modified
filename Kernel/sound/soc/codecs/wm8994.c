...
static const char *playback_path[] = { "OFF", "RCV", "SPK", "HP3P", "HP4P", "BT", "DUAL", "RING_SPK", "RING_HP", "RING_DUAL", "EXTRA_DOCK_SPEAKER", "TV_OUT", "HDMI_TV_OUT", "HDMI_SPK", "HDMI_DUAL" };
static const char *voicecall_path[] = { "OFF", "RCV", "SPK", "HP3P", "HP4P", "BT", };
        ...
        struct snd_ctl_elem_value *ucontrol)
{
	...
	if(wm8994->testmode_config_flag == SEC_TEST_PBA_DUAL_SPK && (path_num == HP4P || path_num == HP3P))	
	{
