...
//#define SUSPEND_TSP_EN_DIS

#if defined (KEY_LED_CONTROL)
// Key LED controller
#define KEYLED_EN               GPIO_KEY_LED_EN_R05
...
#define REPORTID_NOISESUPPRESSION 15
 ...
 typedef struct
 {
    ...
    /* Detection Configuration */
    uint8_t blen;               /*!< ACMASK Burst length for all object channels*/
    uint8_t tchthr1;             /*!< LCMASK Threshold    */
    uint8_t tchthr2;             /*!< LCMASK Threshold    */
    uint8_t tchdi;              /*!< Detect integration config           */
    uint8_t average;            /*!< LCMASK Sets the filter length on the prox signal */
    uint8_t rate1;               /*!< Sets the rate that prox signal must exceed */
    uint8_t rate2;               /*!< Sets the rate that prox signal must exceed */
 ...
 typedef struct
 {
    uint8_t upsiglim1;              /* LCMASK */
    uint8_t upsiglim2;              /* LCMASK */
    uint8_t losiglim1;              /* LCMASK */
    uint8_t losiglim2;              /* LCMASK */
 ...
 {
     uint16_t id;         /*!< id */
     int16_t pressure;      /*!< dn=1, up=0, none=-1 */
     int16_t x;          /*!< X */
     int16_t y;          /*!< Y */
