...
#define TEMP_HIGH_BLOCK		temper_table[66][0] /* 46C */
#define TEMP_HIGH_RECOVER	temper_table[63][0] /* 43C */
#define TEMP_LOW_BLOCK		temper_table[20][0] /* 0C */
#define TEMP_LOW_RECOVER	temper_table[23][0] /* 3C */
#elif defined(CONFIG_TARGET_LOCALE_VZW)
#define TEMP_HIGH_BLOCK		temper_table[72][0] /* 52C */
#define TEMP_HIGH_RECOVER	temper_table[62][0] /* 42C */
#define TEMP_LOW_BLOCK		temper_table[16][0] /* -4C */
#define TEMP_LOW_RECOVER	temper_table[20][0] /* 0C */
#else
#define TEMP_HIGH_BLOCK		temper_table[72][0] /* 52C */
...
#define TEMP_FG_HIGH_BLOCK		51000
#define TEMP_FG_HIGH_RECOVER	44000
#define TEMP_FG_LOW_BLOCK		1000
#define TEMP_FG_LOW_RECOVER	4000
#elif defined(CONFIG_TARGET_LOCALE_VZW)
#define TEMP_FG_HIGH_BLOCK		53000	// P1_VZW (2010-09-26. Fix P100917-0111)
#define TEMP_FG_HIGH_RECOVER		42000
#define TEMP_FG_LOW_BLOCK	    (-4000)
#define TEMP_FG_LOW_RECOVER		0
#else
...
#define TOTAL_CHARGING_TIME	(2*60*1000)	/* 2 min */
#else
