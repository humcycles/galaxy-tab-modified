...
/** \mainpage BMA150 / BMA020 In Line Calibration
 * Copyright (C) 2007 Bosch Sensortec GmbH
 *  \section intro_sec Introduction
 * BMA150 / BMA020 3-axis digital Accelerometer In Line Calibration Process
 * This software is compatible with all Bosch Sensortec BMA020 / BMA150 API >=1.1
 *
