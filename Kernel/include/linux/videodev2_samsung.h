...
/* sensor state */
#define V4L2_MODE_PREVIEW		0x00000000	/*  preview mode */ //JWWON 2010.08.16 add sensor state
#define V4L2_MODE_CAPTURE		0x00000001	/*  capture mode */ //JWWON 2010.08.16 add sensor state
...
#define V4L2_CID_CAMERA_GPS_LATITUDE		(V4L2_CID_PRIVATE_BASE+86)
#define V4L2_CID_CAMERA_GPS_LONGITUDE	(V4L2_CID_PRIVATE_BASE+87)
#define V4L2_CID_CAMERA_GPS_TIMESTAMP	(V4L2_CID_PRIVATE_BASE+88)
#define V4L2_CID_CAMERA_GPS_ALTITUDE		(V4L2_CID_PRIVATE_BASE+89)
...
#define V4L2_CID_CAMERA_FLASH_CHECK					(V4L2_CID_PRIVATE_BASE+117)
