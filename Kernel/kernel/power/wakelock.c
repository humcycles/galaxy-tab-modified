...
//	printk("wake_lock: AudioOutLock:%d, AudioLock:%d, vbus_present:%d\n", has_wake_lock_internal("AudioOutLock"), has_wake_lock_internal("AudioLock"), has_wake_lock_internal("vbus_present"));
