...
#define CONFIG_P1_VER_03 // temporary
 ...
 */
static void s5k6aafx_ldo_en(bool en)
{
	printk("<MACHINE> s5k6aafx_ldo_en %d (0:OFF, 1:ON)\n", en);
 ...
 * Dec 07, 2009  initial revision
 */
/*static*/ int s5k6aafx_cam_nrst(bool en)
{
	int err;

	printk("<MACHINE> s5k6aafx_cam_nrst %d (0:LOW, 1:HIGH)\n", en);
 ...
 * Dec 07, 2009  initial revision
 */ 
/*static*/ int s5k6aafx_cam_stdby(bool en)
{
	int err;

	printk("<MACHINE> s5k6aafx_cam_stdby %d (0:LOW, 1:HIGH)\n", en);
...
static int s5k6aafx_power_onoff(int en)
{
	printk("<MACHINE> s5k6aafx_power_onoff : %d (0:OFF, 1:ON)\n", en);
...
{
        s5k6aafx_power_onoff(0);
   //    mdelay(50);
        s5k6aafx_power_onoff(1);
	return 0;
}
...
static struct s3c_platform_camera s5k6aafx = {
	...
	.initialized 	= 0,
	.cam_power	= s5k6aafx_power_onoff,
};
#endif
...
{
	printk("<MACHINE> isx005_ldo_en %d (0:OFF, 1:ON)\n", en);
...
/*static*/ int isx005_cam_stdby(bool en)
{
	...
	printk("<MACHINE> isx005_cam_stdby %d (0:LOW, 1:HIGH)\n", en);
 ...
 * Dec 07, 2009  initial revision
 */
/*static*/ int isx005_cam_nrst(bool en)
{
	int err = 0;

	printk("<MACHINE> isx005_cam_nrst %d (0:LOW, 1:HIGH)\n", en);
 ...
 * Dec 07, 2009  initial revision
 */
static int isx005_power_onoff(int en)
{
    printk("<MACHINE> isx005_power_onoff : %d (0:OFF, 1:ON)\n", en);	
...
{
        isx005_power_onoff(0);
  //      mdelay(50);
       isx005_power_onoff(1);
...
static struct s3c_spi_pdata s3c_slv_pdata_2[] __initdata = {
        [0] = { /* Slave-0 */
                .cs_level     = CS_FLOAT,
                .cs_pin       = S5PV210_GPH1(0),
                .cs_mode      = S5PV210_GPH1_OUTPUT(0),
                .cs_set       = s3c_cs_set,
                .cs_config    = s3c_cs_config,
                .cs_suspend   = s3c_cs_suspend,
                .cs_resume    = s3c_cs_resume,
...
static struct spi_board_info s3c_spi_devs[] __initdata = {
        ...
        [2] = {
                .modalias        = "tdmbspi", //"spidev", /* Test Interface */
                .mode            = SPI_MODE_0,  /* CPOL=0, CPHA=0 */
...
static struct s3cfb_lcd lvds = {
        ...
        .timing = {
                .h_fp = 50, //50,	//179,	//.h_fp = 79,
                .h_bp = 60, //30,	//225,	//.h_bp = 200,
                .h_sw = 35, //20,	//40,
                .v_fp = 10, //6,	//10,
                .v_fpe = 1,
                .v_bp = 11, //5,	//11,
...
//        writel(0x000000ff, S5P_VA_GPIO + 0x18c);
	if(HWREV>6)
		...
		{
		// for P1 kor rev0.5
        writel(0x55555515, S5P_VA_GPIO + 0x12c);
        writel(0x55555555, S5P_VA_GPIO + 0x14c);
        writel(0x55555555, S5P_VA_GPIO + 0x16c);
        writel(0x00000055, S5P_VA_GPIO + 0x18c);
		}
...
static void gpio_keys_cfg_gpio(void)
{
...
#endif
#ifdef CONFIG_FB_S3C_CMC623
	&sec_device_tune_cmc623,	// P1_LSJ : DE10
#endif
};
                                       ...
                                       struct meminfo *mi)
{
	...
	// Bootloader saves 3Gb/4Gb flag to 0x30002000
	// which kernel can access without memory initilzing.
	if(__raw_readl(0x30002000)==0x80) {
		mi->bank[2].start = 0x50000000;
		mi->bank[2].size = 128 * SZ_1M;
		mi->bank[2].node = 2;
		mi->nr_banks = 3;
	} else if(__raw_readl(0x30002000)==0x100) {
		mi->bank[2].start = 0x50000000;
...
/*
#ifdef CONFIG_FB_S3C_CMC623
	{S5PV210_GPC1(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
		S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPC1(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
		S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPC1(2), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
		S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPC1(3), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
		S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPC1(4), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
		S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN}, 
#else
...
//			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	...
	{S5PV210_GPJ1(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
        {S5PV210_GPJ1(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE,  // MASSMEMORY_EN
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
...
//			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
        ...
        {S5PV210_GPJ2(3), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE,
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
        {S5PV210_GPJ2(4), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE,
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
...
static unsigned int p1_r05_sleep_gpio_table[][3] = {
	...
	{S5PV210_GPA0(6),  // NC
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPA0(7),  // TOUCH_EN (P1_KOR)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
...
//	{S5PV210_GPB(3),  // GPIO_BT_nRST
//			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPB(4),  // TDMB_SPI_CLK (P1_KOR)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPB(5),  // TDMB_SPI_CS (P1_KOR)
			S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPB(6),  // TDMB_SPI_DO (P1_KOR)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPB(7),  // TDMB_SPI_DI (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
...
#if 0  // Rev0.5
	{S5PV210_GPG3(0),  // WIMAX_SDIO_CLK (P1_KOR)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG3(1),  // WIMAX_SDIO_CMD (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG3(2),  // NC
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG3(3),  // WIMAX_SDIO_D(0) (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG3(4),  // WIMAX_SDIO_D(1) (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG3(5),  // WIMAX_SDIO_D(2) (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG3(6),  // WIMAX_SDIO_D(3) (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},
#else  // Rev0.6
	{S5PV210_GPG3(0),
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
...
//			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPJ0(5),  // NC
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ0(6),  // FLM_SEL
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ0(7),  // USIM_BOOT
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 

	{S5PV210_GPJ1(0), 
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ1(1),  // MESSMEMORY_EN (P1_KOR)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ1(2), 
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ1(4), 
...
#if 0  // Rev0.5
	{S5PV210_GPJ2(0),  // WIMAX_EN (P1_KOR)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ2(1),
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
#else  // Rev0.6
	{S5PV210_GPJ2(0),  // CHARGER_SDA_2.8V (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ2(1),  // CHARGER_SCL_2.8V (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
#endif			
	{S5PV210_GPJ2(2), 
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ2(3), 
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ2(4),  // BT_WAKE (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ2(5),  // WLAN_WAKE (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ2(7), 
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPJ3(1), 
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
#if 0  // Rev0.5
	{S5PV210_GPJ3(2),  // WIMAX_USB_EN (P1_KOR)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
#else  // Rev0.6
	{S5PV210_GPJ3(2),  // OVP_FLAG (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
#endif
	{S5PV210_GPJ3(3), 
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
...
// This pin is controlled by sound. - GPIO_MICBIAS_EN
	...
	{S5PV210_MP04(3), 
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP04(4),   // TDMB_EN (P1_KOR)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP04(5),  // CMC_SDA_1.8V (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP04(6),  // CMC_SCL_1.8V (P1_KOR)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP04(7), // MHL_RST
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
...
static unsigned int p1_r10_sleep_gpio_table[][3] = {
	...
	{S5PV210_GPA0(6),  // NC
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPA0(7),  // NC (TOUCH_EN connected at Rev0.8)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
...
// This pin is controlled by sound. - GPIO_MICBIAS_EN
	...
	{S5PV210_MP05(0),  // LCD_ID
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP05(1),  // LCD_BACKLIGHT_EN
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP05(2),  // AP_SCL_1.8V
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP05(3),  // AP_SDA_1.8V
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP05(4),  // NC
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP05(6),  // NC
...
static unsigned int p1_r14_sleep_gpio_table[][3] = {
	{S5PV210_GPB(1),  // MSENSE_nRST
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_MP04(2),  // CAM_FLASH_SET
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP04(3),  // CAM_FLASH_EN
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP05(0),  // NC
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
	{S5PV210_MP05(1),  // EAR_MICBIAS_EN
			S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP05(4),  // LVDS_SHDN
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
};

static unsigned int p1_r15_sleep_gpio_table[][3] = {
	{S5PV210_MP01(2),  // EAR_MICBIAS_EN
			S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
};
...
//	s3c_gpio_setpin(GPIO_REMOTE_SENSE_IRQ, 0);
	...
	if(HWREV >= 11) {   // Above P1 KOR Rev0.9 (TOUCH_EN)
		s3c_gpio_cfgpin(GPIO_TOUCH_EN_R08, S3C_GPIO_OUTPUT);
		s3c_gpio_setpull(GPIO_TOUCH_EN_R08, S3C_GPIO_PULL_NONE);
		s3c_gpio_setpin(GPIO_TOUCH_EN_R08, 0);
	}
	else if(HWREV >= 10) {  // Above P1 KOR Rev0.8 (TOUCH_EN)
		s3c_gpio_cfgpin(GPIO_TOUCH_EN_R08, S3C_GPIO_INPUT);
		s3c_gpio_setpull(GPIO_TOUCH_EN_R08, S3C_GPIO_PULL_NONE);
		//s3c_gpio_setpin(S3C_GPIO_OUTPUT, 0);
	}
	else {
	...
	if(HWREV >= 11) {   // Above P1 KOR Rev0.9 (GYRO_INT)
		...
		s3c_gpio_cfgpin(GPIO_GPH22, S3C_GPIO_INPUT);
	...
	if(HWREV >= 10) {  // Above P1 KOR Rev0.8 (DOCK_INT)
	...
	if(HWREV >= 10) {  // Above P1 KOR Rev0.8
		s3c_config_sleep_gpio_table(ARRAY_SIZE(p1_r10_sleep_gpio_table),
			p1_r10_sleep_gpio_table);

		if(HWREV >= 11) {  // Rev0.9 : only 1 gpio is different from Rev0.8
			s3c_config_sleep_gpio_table(ARRAY_SIZE(p1_r11_sleep_gpio_table),
				p1_r11_sleep_gpio_table);
		}

		if(HWREV >= 14) {  // P1 KOR Rev1.2
			s3c_config_sleep_gpio_table(ARRAY_SIZE(p1_r14_sleep_gpio_table),
				p1_r14_sleep_gpio_table);
		}

		if(HWREV >= 15) {  // P1 KOR Rev1.3 & Rev1.4
	...
	else if(HWREV >= 5) {  // Above P1 KOR Rev0.4
...
#else        
        I2C_BOARD_INFO("sain_touch", 0x20), // kmj_sain       
#endif        
    },
};
...
static void ambient_light_sensor_reset(void)
{
	...
	if(gpio_request(gpio, "ALS_nRST"))
		printk(KERN_ERR "Filed to request ALS_nRST!\n");
...
static void __init qt_touch_init(void)
{
    ...
    if(HWREV >= 0xb)
        ...
        gpio = S5PV210_GPA0(7);			/* XMMC3DATA_3 */
    if(gpio_request(gpio, "TOUCH_EN"))
        printk(KERN_ERR "Filed to request TOUCH_EN!\n");
    s3c_gpio_cfgpin(gpio, S3C_GPIO_OUTPUT);
    gpio_direction_output(gpio, 1);

    gpio = S5PV210_GPJ0(5);				/* XMSMADDR_5 */
    if(gpio_request(gpio, "TOUCH_INT"))
        printk(KERN_ERR "Filed to request TOUCH_INT!\n");
...
#ifdef FEATURE_SAIN_TOUCH
static void __init saint_touch_init(void)
{
    int gpio, irq;

    printk("    saint_touch_init in mach-p1.c\n");
    gpio = S5PV210_GPA0(7);			/* XMMC3DATA_3 */
    ...
    s3c_gpio_setpull(gpio, S3C_GPIO_PULL_UP);
    irq = gpio_to_irq(gpio);
    i2c_devs3[0].irq = IRQ_EINT_GROUP(18, 5);

//    i2c_devs3[0].flags = 0x4000;// kmj_df07  
}
#endif
...
#if 1 // FIXME, workaround for REV03
	if(HWREV == 0xC)
	{
		HWREV = 1;
	}
...
//     	platform_device_register(&mdnie_pwm_backlight);
		...
		if(HWREV < 0x5) {
#ifndef FEATURE_SAIN_TOUCH		
		qt602240_set_amoled_display(1); // kmj_sain
#endif		
#ifdef CONFIG_FB_S3C_AMS701KA
...
// rev0.8 use XMMC3 for WLAN
static unsigned int wlan_gpio_table_r08[][4] = {	
	{GPIO_WLAN_nRST_R08, GPIO_WLAN_nRST_R08_AF, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE},
	{GPIO_WLAN_HOST_WAKE, GPIO_WLAN_HOST_WAKE_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_DOWN},
	{GPIO_WLAN_WAKE, GPIO_WLAN_WAKE_AF, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE},
};

static unsigned int wlan_sdio_on_table_r08[][4] = {
	{GPIO_WLAN_SDIO_CLK_R08, GPIO_WLAN_SDIO_CLK_R08_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
	{GPIO_WLAN_SDIO_CMD_R08, GPIO_WLAN_SDIO_CMD_R08_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
	{GPIO_WLAN_SDIO_D0_R08, GPIO_WLAN_SDIO_D0_R08_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
	{GPIO_WLAN_SDIO_D1_R08, GPIO_WLAN_SDIO_D1_R08_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
	{GPIO_WLAN_SDIO_D2_R08, GPIO_WLAN_SDIO_D2_R08_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
	{GPIO_WLAN_SDIO_D3_R08, GPIO_WLAN_SDIO_D3_R08_AF, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
};

static unsigned int wlan_sdio_off_table_r08[][4] = {
	{GPIO_WLAN_SDIO_CLK_R08, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE},
	{GPIO_WLAN_SDIO_CMD_R08, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
	{GPIO_WLAN_SDIO_D0_R08, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
	{GPIO_WLAN_SDIO_D1_R08, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
	{GPIO_WLAN_SDIO_D2_R08, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
	{GPIO_WLAN_SDIO_D3_R08, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
};
...
void wlan_setup_power(int on, int flag)
{
	...
	if (flag != 1) {	
		...
		if (HWREV >= 0xa) {
			if (on)
				gpio_set_value(GPIO_WLAN_nRST_R08, GPIO_LEVEL_HIGH);		
			else
				gpio_set_value(GPIO_WLAN_nRST_R08, GPIO_LEVEL_LOW);		
			return;
		} else {
			if (on)
	...
	if (on) {
		if (HWREV >= 0xa) {
			s3c_config_gpio_alive_table(ARRAY_SIZE(wlan_gpio_table_r08), wlan_gpio_table_r08);
			s3c_config_gpio_alive_table(ARRAY_SIZE(wlan_sdio_on_table_r08), wlan_sdio_on_table_r08);
		} else {
		...
		if (HWREV >= 0xa) {
			gpio_set_value(GPIO_WLAN_nRST_R08, GPIO_LEVEL_HIGH);
			s3c_gpio_slp_cfgpin(GPIO_WLAN_nRST_R08, S3C_GPIO_SLP_OUT1);
			
			printk(KERN_DEBUG "WLAN: GPIO_WLAN_BT_EN = %d, GPIO_WLAN_nRST = %d\n", 
				   gpio_get_value(GPIO_WLAN_BT_EN), gpio_get_value(GPIO_WLAN_nRST_R08));
		} else {
			gpio_set_value(GPIO_WLAN_nRST, GPIO_LEVEL_HIGH);
		...
		if (HWREV >= 0xa) {
			gpio_set_value(GPIO_WLAN_nRST_R08, GPIO_LEVEL_LOW);
			s3c_gpio_slp_cfgpin(GPIO_WLAN_nRST_R08, S3C_GPIO_SLP_OUT0);
		...
		if (HWREV >= 0xa) {
			s3c_config_gpio_alive_table(ARRAY_SIZE(wlan_sdio_off_table_r08), wlan_sdio_off_table_r08);		
			}
		else
			{
...
MACHINE_START(SMDKC110, "SHW-M180S") /*2010.9.13 cm.chung: change hardware name */
