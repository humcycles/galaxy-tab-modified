...
static struct i2c_board_info i2c_devs7r03[] __initdata = {
	{
		I2C_BOARD_INFO("smb136", 0x80 >> 1),
	}, 
};
...
//			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPJ1(0), 
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, //VZW Only
	{S5PV210_GPJ1(1),  // MESSMEMORY_EN
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ1(2), 
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
...
//	s3c_gpio_setpin(GPIO_HDMI_HPD,0);
	...
	s3c_gpio_setpull(GPIO_MSENSE_IRQ, S3C_GPIO_PULL_UP); //HW request 09/16
	...
	if(HWREV >= 11) {   // DOCK_INT (GT-P1000 Rev0.5)
		...
		s3c_gpio_setpull(GPIO_DOCK_INT, S3C_GPIO_PULL_NONE); //s-composite TV out fixed 10/20
...
static void __init smdkc110_machine_init(void)
{
	...
	i2c_register_board_info(12, i2c_devs12, ARRAY_SIZE(i2c_devs12));
        ...
        if(HWREV == 0x9)
		i2c_register_board_info(7, i2c_devs7r03, ARRAY_SIZE(i2c_devs7));
	else{
	     if(HWREV >= 0x8)
