...
#else
#define GPIO_GPB4					S5PV210_GPB(4)

#define GPIO_GPB5					S5PV210_GPB(5)
...
/* GPD0 */
#define GPIO_TOUCH_KEY_SCL			S5PV210_GPD0(0)
#define GPIO_KEY_LED_EN_R05		S5PV210_GPD0(0)  // Rev0.5

#define GPIO_VIBTONE_PWM_L		S5PV210_GPD0(1)
#define GPIO_VIBTONE_PWM_L_AF 		2
#define GPIO_VIBTONE_PWM			S5PV210_GPD0(1)  // Rev0.4
#define GPIO_VIBTONE_PWM_AF 		2

#if defined(CONFIG_TARGET_LOCALE_LTN) 
#define GPIO_ATV_RSTn_REV07		S5PV210_GPD0(1)   // CYS_ 2010.07.12 Rev0.7 (Only latin HW03) 
#define GPIO_HWREV_MODE4		S5PV210_GPD0(2)
#endif

#define GPIO_VIBTONE_PWM_R		S5PV210_GPD0(2)
#define GPIO_VIBTONE_PWM_R_AF		2

#define GPIO_GPD03				S5PV210_GPD0(3)
#define GPIO_LCD_CABC_PWM_R05		S5PV210_GPD0(3)  // Rev0.5

#if defined(CONFIG_TARGET_LOCALE_LTN) 
#define GPIO_ATV_RSTn_REV10		S5PV210_GPD0(3)   // DerekJi_ 2010.07.26 Rev1.0 (Only latin HW04) 
#endif

/* GPD1 */
#define GPIO_CAM_SDA_2_8V			S5PV210_GPD1(0)
#define GPIO_CAM_SDA_2_8V_AF		2

#define GPIO_CAM_SCL_2_8V			S5PV210_GPD1(1)
#define GPIO_CAM_SCL_2_8V_AF		2
...
#define GPIO_AP_TOUCH_SDA_2_8V	S5PV210_GPD1(4)
#define GPIO_AP_TOUCH_SDA_2_8V_AF	2	

#define GPIO_AP_TOUCH_SCL_2_8V		S5PV210_GPD1(5)
#define GPIO_AP_TOUCH_SCL_2_8V_AF	2
...
#define GPIO_GPS_nRST_REV06		S5PV210_GPG1(0)

#define GPIO_WLAN_SDIO_CMD		S5PV210_GPG1(1)
#define GPIO_WLAN_SDIO_CMD_AF		2
#define GPIO_GPS_PWR_EN_REV06		S5PV210_GPG1(1)
...
#define GPIO_GPG12				S5PV210_GPG1(2)
...
#define GPIO_WLAN_SDIO_CLK_REV06		S5PV210_GPG3(0)
#define GPIO_WLAN_SDIO_CLK_REV06_AF	2

#define GPIO_GPS_PWR_EN			S5PV210_GPG3(1)
#define GPIO_WLAN_SDIO_CMD_REV06		S5PV210_GPG3(1)
#define GPIO_WLAN_SDIO_CMD_REV06_AF	2

#define GPIO_TOUCH_KEY_SDA		S5PV210_GPG3(2)
#define GPIO_GPG32				S5PV210_GPG3(2)  // Rev0.5
#define GPIO_WLAN_nRST_REV06			S5PV210_GPG3(2)
#define GPIO_WLAN_nRST_REV06_AF		1

#define GPIO_TA_nSTAT				S5PV210_GPG3(3)
#define GPIO_WLAN_SDIO_D0_REV06		S5PV210_GPG3(3)
#define GPIO_WLAN_SDIO_D0_REV06_AF	2

#define GPIO_BT_WAKE				S5PV210_GPG3(4)
#define GPIO_WLAN_SDIO_D1_REV06		S5PV210_GPG3(4)
#define GPIO_WLAN_SDIO_D1_REV06_AF	2

#if !defined(CONFIG_TARGET_LOCALE_LTN)
#define GPIO_WLAN_WAKE			S5PV210_GPG3(5)
#define GPIO_WLAN_WAKE_AF		1
#endif
#define GPIO_WLAN_SDIO_D2_REV06 		S5PV210_GPG3(5)
#define GPIO_WLAN_SDIO_D2_REV06_AF	2

#if !defined(CONFIG_TARGET_LOCALE_LTN)
#define GPIO_TOUCH_EN				S5PV210_GPG3(6)
#define GPIO_TOUCH_EN_AF			1
#endif
#define GPIO_WLAN_SDIO_D3_REV06 		S5PV210_GPG3(6)
#define GPIO_WLAN_SDIO_D3_REV06_AF	2
...
#define GPIO_AP_PMIC_IRQ_AF		0xF

/* GPH1 */
#define GPIO_GPH10				S5PV210_GPH1(0)
#define GPIO_DET_35_R04			S5PV210_GPH1(0)  // Rev0.4
#define GPIO_DET_35_R04_AF			0xF

#define GPIO_TA_nCHG				S5PV210_GPH1(1)
#define GPIO_TA_nCHG_AF			0xF
...
#define GPIO_EAR_SEND_END_R04		S5PV210_GPH1(4)  // Rev0.4
#define GPIO_EAR_SEND_END_R04_AF	0xF

#define GPIO_HDMI_HPD				S5PV210_GPH1(5)
#define GPIO_HDMI_HPD_AF			4

#define GPIO_FUEL_ARLT				S5PV210_GPH1(6)
#define GPIO_FUEL_ARLT_AF			0xF
...
#define GPIO_VOL_UP_R05			S5PV210_GPH3(0)  // Rev0.5
#define GPIO_VOL_UP_R05_AF			0xf

#define GPIO_KBR1					S5PV210_GPH3(1)
#define GPIO_KBR1_AF				3
#define GPIO_VOL_DOWN_R05		S5PV210_GPH3(1)  // Rev0.5
#define GPIO_VOL_DOWN_R05_AF		0xf
...
#define GPIO_HOME_KEY				S5PV210_GPH3(5)
#define GPIO_HOME_KEY_AF			0xF
...
#define GPIO_GPJ05					S5PV210_GPJ0(5)  // Rev0.5
...
#endif
#if defined(CONFIG_TARGET_LOCALE_LTN)	// assign to not used gpio
#define GPIO_PHONE_ON				S5PV210_MP05(5)
#else
#define GPIO_PHONE_ON				S5PV210_GPJ1(0)
#endif

#define GPIO_HAPTIC_EN_L			S5PV210_GPJ1(1)
#if defined(CONFIG_TARGET_LOCALE_LTN)
#define GPIO_VIBTONE_EN			S5PV210_GPJ1(1)  // Rev0.4
#else
#define GPIO_VIBTONE_EN			S5PV210_GPJ1(3)  
#endif
...
#define GPIO_MLCD_ON				S5PV210_GPJ1(3)
#endif

#define GPIO_HAPTIC_EN_R			S5PV210_GPJ1(4)
#define GPIO_GPJ14					S5PV210_GPJ1(4)  // Rev0.4
#define GPIO_ACCESSORY_EN_REV06		S5PV210_GPJ1(4)  // Rev1.2
...
#define GPIO_MOT_R_SDA_2_8V		S5PV210_GPJ2(0)
#define GPIO_GPJ20					S5PV210_GPJ2(0)  // Rev0.4

#define GPIO_MOT_R_SCL_2_8V		S5PV210_GPJ2(1)
#define GPIO_GPJ21					S5PV210_GPJ2(1)  // Rev0.4
...
#define GPIO_GPJ24					S5PV210_GPJ2(4)  // Rev0.4
#define GPIO_BT_WAKE_REV06			S5PV210_GPJ2(4)
#define GPIO_MASSMEMORY_EN2			S5PV210_GPJ2(4)  // Rev0.3
...
#define GPIO_FM_BUS_nRST			S5PV210_GPJ2(5)
#define GPIO_GPJ25					S5PV210_GPJ2(5)  // Rev0.4
#define GPIO_WLAN_WAKE_REV06			S5PV210_GPJ2(5)  // Rev1.2
...
//#define GPIO_LDO_EN			    S5PV210_GPJ3(2)
#define GPIO_ISDBT_PWR_EN_REV10		S5PV210_GPJ3(2)
#endif
#define GPIO_EAR_ADC_SEL			S5PV210_GPJ3(2)
#define GPIO_GPJ32					S5PV210_GPJ3(2)  // Rev0.4
...
#define GPIO_AP_I2C_SDA_28V		S5PV210_GPJ3(6)

#define GPIO_AP_I2C_SCL_28V			S5PV210_GPJ3(7)

/* GPJ4 */
#define GPIO_AP_PMIC_SDA			S5PV210_GPJ4(0)

#define GPIO_GPJ41					S5PV210_GPJ4(1)
#define GPIO_CURR_ADJ				S5PV210_GPJ4(1)  // Rev0.4
...
#define GPIO_MICBIAS2_1			S5PV210_MP01(5)
...
/* MP04 */
#if defined(CONFIG_TARGET_LOCALE_LTN)
#define GPIO_GPS_CNTL				S5PV210_MP04(0)
#endif
#define GPIO_MP040				S5PV210_MP04(0)
#define GPIO_GPS_CNTL_REV06			S5PV210_MP04(0)

#if defined(CONFIG_TARGET_LOCALE_LTN) //  Rev1.0 (Only latin HW04)  
#define GPIO_TV_CLK_EN 	        S5PV210_MP04(1)
#endif 

#define GPIO_DISPLAY_CLK			S5PV210_MP04(1)
#define GPIO_MP041				S5PV210_MP04(1)  // Rev0.5

#if defined(CONFIG_TARGET_LOCALE_LTN) //Derek
#define GPIO_FLASH_EN1	        S5PV210_MP04(2)
#define GPIO_FLASH_EN2			S5PV210_MP04(3)  
#endif 

#define GPIO_DISPLAY_SO			S5PV210_MP04(2)
#define GPIO_MP042				S5PV210_MP04(2)  // Rev0.5

#define GPIO_DISPLAY_SI				S5PV210_MP04(3)
#define GPIO_MP043				S5PV210_MP04(3)  // Rev0.5
#define GPIO_CMC_SCL_18V			S5PV210_MP04(3)  // Rev0.9
...
#if !defined(CONFIG_TARGET_LOCALE_LTN)
#define GPIO_GPS_CNTL				S5PV210_MP04(6)
#endif
#define GPIO_CMC_SCL_18V_REV06			S5PV210_MP04(6)  // Rev1.2

#define GPIO_MHL_RST				S5PV210_MP04(7)

/* MP05 */
#define GPIO_LCD_ID				S5PV210_MP05(0)

#define GPIO_LCD_BACKLIGHT_EN		S5PV210_MP05(1)
#define GPIO_MICBIAS2			S5PV210_MP05(1)

#define GPIO_AP_SCL_18V			S5PV210_MP05(2)

#define GPIO_AP_SDA_18V			S5PV210_MP05(3)

#define GPIO_ACCESSORY_EN			S5PV210_MP05(4)
